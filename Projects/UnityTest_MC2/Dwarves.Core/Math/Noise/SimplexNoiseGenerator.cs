// ----------------------------------------------------------------------------
// <copyright file="SimplexNoiseGenerator.cs" company="Acidwashed Games">
...
namespace Dwarves.Core.Math.Noise
{
    ...
    public class SimplexNoiseGenerator : INoiseGenerator
    {
        ...
        /// <returns>Noise value in range -1.0 to 1.0.</returns>
        ...
        /// <summary>
        /// This method is a lot faster than using the Math library.
        /// </summary>
